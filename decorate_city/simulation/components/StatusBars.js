...
StatusBars.prototype.Schema =
    ...
    "</element>" +
    "<optional>" +
        "<element name='ShowHealth'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowUpgrade'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowPack'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowExperience'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowCapture'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowSupply'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowRank'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>" +
    "<optional>" +
        "<element name='ShowAuras'>" +
            "<data type='boolean'/>" +
        "</element>" +
    "</optional>";
...
StatusBars.prototype.AddExperienceBar = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowExperience === false)
	return 0;
...
StatusBars.prototype.AddPackBar = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowPack === false)
	return 0;
...
StatusBars.prototype.AddUpgradeBar = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowUpgrade === false)
	return 0;
...
StatusBars.prototype.AddHealthBar = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowHealth === false)
		return 0;
...
StatusBars.prototype.AddCaptureBar = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowCapture === false)
	return 0;
...
StatusBars.prototype.AddAuraIcons = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowAuras === false)
	return 0;
...
StatusBars.prototype.AddRankIcon = function(cmpOverlayRenderer, yoffset)
{
	...
	if (this.template.ShowRank === false)
	return 0;
